...
const services = [
    ...
    },
    {
        ...
        title: 'Aumento y Tonificación de glúteo',
    ...
    servicesContainer.innerHTML = services.map(service => `
        <div class="service-card group relative bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 h-80">
            <div class="relative h-full overflow-hidden">
                ...
                <div class="absolute top-4 right-4 w-12 h-12 bg-spa-accent rounded-full flex items-center justify-center shadow-lg">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', function(e) {
            ...
            submitButton.innerHTML = '<span class="flex items-center justify-center"><span class="mr-2">⏳</span>Enviando...</span>';
